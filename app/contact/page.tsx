    ...
    <main>
      ...
      <section className="bg-surface px-6 py-32">
        <div className="mx-auto flex max-w-7xl flex-col gap-24 lg:flex-row">
          ...
          <div className="w-full space-y-12 lg:w-1/2">
            <div>
              ...
              <p className="max-w-md font-body text-lg leading-relaxed text-on-surface-variant">
                Whether you already have plans in motion or you are still clarifying what the garden
                needs, we can begin with a focused conversation about the site, priorities, and budget.
              </p>
            </div>
            ...
            <div className="space-y-6 border-t border-outline-variant/30 pt-4">
              <div className="flex items-center gap-4 text-primary">
                ...
                <div>
                  <h4 className="font-headline text-xs font-bold uppercase tracking-widest text-primary-fixed-dim">
                    Direct line
                  </h4>
          ...
          {/* Right: form */}
          <div className="w-full rounded-2xl border border-outline-variant/10 bg-surface-container-lowest p-10 shadow-2xl md:p-16 lg:w-1/2">
            <h3 className="mb-10 text-center font-display text-3xl text-primary">
              Project enquiry
            </h3>
            <ContactForm />
          </div>
