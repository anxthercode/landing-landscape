...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-[870px] flex flex-col md:flex-row overflow-hidden bg-surface">
      ...
      <div className="w-full md:w-[45%] h-[500px] md:h-auto relative z-10 overflow-hidden">
        <motion.div
